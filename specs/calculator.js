...
describe('Twilio Pricing Calculator', () => {
    beforeEach('Open the calculator page and close the cookie dialog', async () => {
        CalculatorPage.open();
    ...
    it('Should show 0$ savings for messaging API if a user remove the services', async () => {
        await CalculatorPage.removeMessagingApiSavings();
